...
completed_test01 = CompletedTest.create(user_id: neo.id, test_id: ruby.id, level: ruby.level)
completed_test02 = CompletedTest.create(user_id: neo.id, test_id: html.id, level: html.level)
completed_test03 = CompletedTest.create(user_id: trinity.id, test_id: java.id, level: java.level)
completed_test04 = CompletedTest.create(user_id: morpheus.id, test_id: python.id, level: python.level)
